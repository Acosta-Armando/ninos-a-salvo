      ...
      <main className='mx-auto max-w-2xl space-y-6 px-4 py-6'>
        {isReencontrado ? (
          <Card className='border-green-300 bg-green-50 dark:border-green-800 dark:bg-green-950/40'>
            <CardHeader>
              <CardTitle className='text-green-800 dark:text-green-200'>Registro cerrado</CardTitle>
            </CardHeader>
            <CardContent className='space-y-2 text-sm'>
              <p className='text-green-800/90 dark:text-green-200/90'>
                Los reencuentros y la custodia de menores deben ser responsabilidad de organismos competentes, no de
                esta plataforma.
              </p>
              {child.retiro_fullname ? (
                <>
                  <dl className='space-y-2 rounded-lg border bg-card p-4'>
                    <div>
                      <dt className='text-muted-foreground'>Registro asociado a</dt>
                      <dd className='text-lg font-semibold'>{child.retiro_fullname}</dd>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <dd>
                        <a href={`tel:${child.retiro_telefono}`} className='text-primary hover:underline'>
        ...
        <Card>
          ...
          <CardContent className='space-y-3'>
            <p className='text-lg font-semibold'>{formatEdadEstimada(child.edad_estimada, child.edad_anios)}</p>
            ...
            <div className='flex gap-2 rounded-lg border border-amber-200/80 bg-amber-50/80 p-3 text-xs leading-relaxed text-amber-950 dark:border-amber-900/50 dark:bg-amber-950/30 dark:text-amber-100'>
              ...
              <p>
                Por protección de niños, niñas y adolescentes (LOPNNA), no publicamos fotografías en internet. Para
                verificar identidad, llama o acude al punto de resguardo.
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className='space-y-4'>
            ...
            <div>
              <p className='text-sm text-muted-foreground'>Descripción del sitio</p>
          ...
          <CardContent className='space-y-2'>
            ...
            {!esFallecido && !isReencontrado ? (
              <p className='border-t py-3 text-xs leading-relaxed text-muted-foreground'>
                Este contacto sirve para ubicar al niño, niña o adolescente y al punto de resguardo. No uses esta
                plataforma para coordinar ni autorizar entregas: eso corresponde a los organismos competentes.
              </p>
            ) : null}
          </CardContent>
        </Card>
